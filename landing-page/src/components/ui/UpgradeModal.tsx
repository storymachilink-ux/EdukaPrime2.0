...
export const UpgradeModal: React.FC<UpgradeModalProps> = ({
  ...
  const handleCheckoutClick = (planKey: string) => {
    ...
    trackCheckoutOpen(plan.name, parseFloat(price));
              ...
              return (
                ...
                >
                  ...
                  <button
                    ...
                    className={`w-full py-3 md:py-4 px-4 md:px-6 rounded-xl font-bold transition-colors text-sm md:text-base touch-manipulation cursor-pointer ${
                      planKey === 'prime'
