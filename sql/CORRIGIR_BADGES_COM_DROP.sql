...
-- COM DROP DAS FUNÇÕES ANTIGAS
-- Execute este SQL AGORA para corrigir
-- ============================================

-- PRIMEIRO: Dropar as funções antigas
DROP FUNCTION IF EXISTS check_and_unlock_download_badges(UUID);
DROP FUNCTION IF EXISTS check_and_unlock_completed_badges(UUID);
DROP FUNCTION IF EXISTS check_and_unlock_chat_points_badges(UUID);

-- SEGUNDO: Criar funções corrigidas com novos nomes de retorno
...
-- TERCEIRO: RECRIAR TRIGGERS (garantir que usam as funções corrigidas)
