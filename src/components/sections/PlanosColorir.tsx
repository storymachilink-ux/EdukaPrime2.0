...
export const PlanosColorir: React.FC = () => {
  const { trackProductClick } = usePixelTracking();

  const handleCheckoutClick = () => {
    const productName = 'Pequenos Gênios da Arte';
    const price = 29.99;
    ...
    const utm_medium = params.get('utm_medium') || 'colorir';
    const utm_campaign = params.get('utm_campaign') || 'pequenos-genios';
    const utm_content = params.get('utm_content') || 'arte-kit';
  ...
  // Componente de Card Animado Único
  const AnimatedPricingCard = () => {
    ...
    return (
      ...
      >
        ...
        <motion.div
          className={cn(
            "absolute -top-4 -right-4 w-20 h-20 rounded-full flex items-center justify-center border-3 border-black shadow-[3px_3px_0px_0px_rgba(0,0,0,0.9)]",
            plan.accent
          )}
          animate={{
            rotate: [0, 10, 0, -10, 0],
        ...
        <div className="mb-4">
          ...
          <div className="mt-4 flex justify-center">
            <img
              src="/img/capa-check.webp"
              alt="Pequenos Gênios da Arte"
            ...
            >
              ...
              <span className="text-black font-bold text-sm">
                {feature.startsWith('Bônus') ? (
                  <>
                    <span className="text-[#f44260]">{feature.split(':')[0]}:</span>
                    {feature.split(':')[1]}
                  </>
                ) : feature.includes('ÚNICO E EXCLUSIVO') ? (
                  <>
                    Material <span className="text-[#f44260]">ÚNICO E EXCLUSIVO</span>
                  </>
                ) : (
                  feature
                )}
        ...
        <motion.div
          className={cn(
            "w-full py-3 rounded-lg text-white font-black text-base text-center border-2 border-black shadow-[4px_4px_0px_0px_rgba(0,0,0,0.9)] hover:shadow-[6px_6px_0px_0px_rgba(0,0,0,0.9)] active:shadow-[2px_2px_0px_0px_rgba(0,0,0,0.9)] transition-all duration-200",
            plan.accent
          )}
          whileHover={{
            scale: 1.02,
    ...
    <section id="planos" className="py-16 md:py-24 bg-[#F8FBFF]">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <div className="relative inline-block mb-8">
            <div className="relative bg-[#FFF3D6] border-2 border-[#8B5CF6] rounded-2xl px-6 py-3 shadow-lg transform rotate-[-1deg] hover:rotate-0 transition-transform duration-300">
              ...
              <div className="text-3xl md:text-4xl lg:text-5xl font-bold text-[#9A6A00] relative z-10">
                <div>Pequenos Gênios da Arte</div>
                <div className="text-[#FF6B2C]">Plano Completo</div>
              </div>
            </div>
          </div>
        </div>
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6 mb-12">
          ...
          <div className="relative group transition-all duration-300 rotate-[-1deg]">
            ...
            <div className="relative p-6">
              ...
              <img src="/TIPOS-DE-OBRAS-1.webp" alt="Obras Clássicas" className="w-full h-48 object-cover rounded-lg mb-4" />
              <h3 className="text-xl font-bold text-[#FF6B2C] mb-2">🎨 60 Obras Clássicas para Colorir</h3>
              <p className="text-sm text-[#033258]">Explore as melhores obras-primas da história da arte com atividades de coloração que estimulam criatividade e aprendizado cultural.</p>
            </div>
          </div>
          ...
          <div className="relative group transition-all duration-300 rotate-[1deg]">
            ...
            <div className="relative p-6">
              ...
              <img src="/TIPOS-DE-OBRAS-2.webp" alt="Artistas Famosos" className="w-full h-48 object-cover rounded-lg mb-4" />
              <h3 className="text-xl font-bold text-[#FF6B2C] mb-2">🖼️ Cartões Visuais - Conheça o Artista!</h3>
              <p className="text-sm text-[#033258]">Aprender sobre grandes mestres da pintura enquanto colore suas obras mais famosas e descobre histórias fascinantes por trás de cada criação.</p>
            </div>
          </div>
          ...
          <div className="relative group transition-all duration-300 rotate-[-0.5deg]">
            ...
            <div className="relative p-6">
              ...
              <img src="/TIPOS-DE-OBRAS-3.webp" alt="Mundo Colorido" className="w-full h-48 object-cover rounded-lg mb-4" />
              <h3 className="text-xl font-bold text-[#FF6B2C] mb-2">🌈 Mundo Colorido - Técnicas e Inspiração</h3>
              <p className="text-sm text-[#033258]">Desenvolva suas técnicas de coloração com inspiração de diferentes movimentos artísticos e estilos, tornando cada criação uma obra-prima.</p>
            </div>
          </div>
          ...
          <div className="relative group transition-all duration-300 rotate-[0.5deg]">
            ...
            <div className="relative p-6">
              ...
              <img src="/TIPOS-DE-OBRAS-4.webp" alt="Material Exclusivo" className="w-full h-48 object-cover rounded-lg mb-4" />
              <h3 className="text-xl font-bold text-[#FF6B2C] mb-2">✨ Material ÚNICO e EXCLUSIVO</h3>
              <p className="text-sm text-[#033258]">Acesso a conteúdo exclusivo e inédito que você não encontra em lugar nenhum, com mais de 200 atividades de qualidade premium.</p>
            </div>
          </div>
        ...
        <div className="mb-12">
          ...
          <div className="bg-[#f43f5e] rounded-2xl px-8 py-6 mb-8 text-center">
            <h2 className="text-2xl md:text-3xl lg:text-4xl font-bold text-white">
              Confira as pinturas das crianças!
            </h2>
          </div>
          ...
          {/* Mini descrição */}
          <p className="text-center text-lg md:text-xl text-[#333] mt-6 italic">
            Arraste e veja as obras-primas criadas por crianças que descobriram sua paixão pela arte!
          </p>

          {/* Título */}
          <h2 className="text-2xl md:text-3xl lg:text-4xl font-bold text-[#333] text-center mt-12 mb-8">
            <span className="text-[#FF6B2C] font-extrabold">Pequenos Gênios da Arte</span> ajudam seu pequeno a:
          </h2>
        </div>
          ...
          <div className="mb-16">
            <h2 className="text-2xl md:text-3xl lg:text-4xl font-bold text-ink text-center mb-12">
              {(() => {
                ...
                return (
                  <>
                    Ao adquirir hoje dia <span className="font-extrabold text-[#FF6B2C]">{day} de {month}</span>, você ganha 03 bônus exclusivos
                  </>
                );
              })()}
            </h2>
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
            ...
            <div className="relative group transition-all duration-300 rotate-[-1deg]">
              ...
              <div className="relative p-6">
                ...
                <img src="/bonus1.webp" alt="Bônus 01" className="w-full h-48 object-cover rounded-lg mb-4" />
                ...
                <h3 className="text-xl font-bold text-[#FF6B2C] mb-3">30 Obras Nacionais para Colorir</h3>
                <p className="text-sm text-[#033258]">Explore as criações de artistas brasileiros incríveis e descubra a riqueza da arte nacional.</p>
              </div>
            </div>
            ...
            <div className="relative group transition-all duration-300 rotate-[1deg]">
              ...
              <div className="relative p-6">
                ...
                <img src="/bonus2.webp" alt="Bônus 02" className="w-full h-48 object-cover rounded-lg mb-4" />
                <div className="text-sm font-bold mb-2 text-left">
                  <span className="bg-[#f3ce74] px-2 py-1 rounded text-[#f44260]">De R$ 39,99</span> <span className="text-green-600">Por R$ 00,00</span>
                </div>
                <h3 className="text-xl font-bold text-[#FF6B2C] mb-3">Cartões Visuais - Conheça o Artista!</h3>
                <p className="text-sm text-[#033258]">Aprenda sobre os grandes mestres enquanto colore suas obras e descobre suas histórias fascinantes.</p>
              </div>
            </div>
            ...
            <div className="relative group transition-all duration-300 rotate-[-0.5deg]">
              ...
              <div className="relative p-6">
                ...
                <img src="/bonus3.webp" alt="Bônus 03" className="w-full h-48 object-cover rounded-lg mb-4" />
                <div className="text-sm font-bold mb-2 text-left">
                  <span className="bg-[#f3ce74] px-2 py-1 rounded text-[#f44260]">De R$ 10,99</span> <span className="text-green-600">Por R$ 00,00</span>
                </div>
                <h3 className="text-xl font-bold text-[#FF6B2C] mb-3">Mundo Colorido - Técnicas e Inspiração</h3>
                <p className="text-sm text-[#033258]">Desenvolva técnicas avançadas de coloração e descubra estilos diferentes para expressar sua criatividade.</p>
              </div>
            </div>
          </div>
        </div>
        ...
        <div className="mb-16">
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8 max-w-6xl mx-auto">
            ...
            <div className="text-center">
              ...
              <p className="text-sm text-[#033258]">As atividades são todas 100% em PDF, após o pagamento você recebe imediatamente o link de acesso no seu e-mail e tem acesso vitalício e atualizações.</p>
            </div>
            ...
            {/* Item 3 - Hora de Colorir */}
            <div className="text-center">
              <img src="/corte.webp" alt="Hora de Colorir" className="w-32 h-32 mx-auto mb-4 object-contain" />
              <h3 className="text-xl font-bold text-[#FF6B2C] mb-3">Hora de Colorir</h3>
              <p className="text-sm text-[#033258]">É hora de colorir, aprender e explorar o universo da arte de forma leve e divertida!</p>
            </div>
          </div>
        </div>
        </div>
        ...
        <div className="mb-16 max-w-4xl mx-auto">
          <div className="text-center mb-8">
            ...
            <p className="text-lg md:text-xl text-[#333] mb-8">
              O Pequenos Gênios da Arte é recomendado por <span className="font-bold text-green-600">educadores e pais, que acreditam no verdadeiro desempenho das crianças e reforçam seu desenvolvimento</span>, o melhor em atividades lúdicas e interativas.
            </p>
          </div>

          <div className="grid grid-cols-1 gap-4 max-w-3xl mx-auto space-y-4">
            <div className="flex items-start gap-3">
              <CheckCircle2 className="w-6 h-6 text-green-600 flex-shrink-0 mt-1" />
              <p className="text-lg text-[#333]">Baseado em princípios pedagógicos reais — estimula coordenação, foco e expressão artística.</p>
            </div>

            <div className="flex items-start gap-3">
              <CheckCircle2 className="w-6 h-6 text-green-600 flex-shrink-0 mt-1" />
              <p className="text-lg text-[#333]">Inspirado na BNCC, une arte, cultura e desenvolvimento motor em cada obra.</p>
            </div>
          </div>
        ...
        <div className="mb-16 max-w-5xl mx-auto text-center">
          <h2 className="text-2xl md:text-3xl lg:text-4xl font-bold text-[#333] mb-8">
            Estimular <span className="font-extrabold text-green-600">criatividade e autoconfiança</span>, vale mais que qualquer presente
          </h2>
          <img
            src="/banner-final.webp?v=20250115"
            alt="Banner Final"
            className="w-full h-auto rounded-2xl shadow-lg"
          />
          ...
          {/* Card Animado Estilo PricingContainer */}
          <div className="mt-8">
            <AnimatedPricingCard />
          </div>
        </div>
        ...
        <div className="bg-[#F1F6FF] rounded-[24px] p-8">
          ...
          <div className="max-w-4xl mx-auto mt-8">
            ...
            <p className="text-lg text-[#4A5568] leading-relaxed text-center">
              Confiamos tanto no poder transformador do <strong>Pequenos Artistas</strong> que você tem <strong>30 dias completos</strong> para experimentar sem risco.<br /><br />
              Se nesse período sentir que o material não encantou seu pequeno ou não trouxe o aprendizado e o vínculo que você esperava, devolvemos <strong>100% do seu investimento</strong> — sem burocracia.
            </p>
