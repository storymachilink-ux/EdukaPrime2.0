        ...
        <>
          ...
          <div className="mb-12">
            <div className="relative inline-block mb-6">
              <div className="relative bg-purple-100 border-2 border-purple-600 rounded-2xl px-6 py-3 shadow-lg transform rotate-[-2deg] hover:rotate-0 transition-transform duration-300">
                ...
                <span className="text-2xl md:text-3xl lg:text-4xl font-bold text-purple-900">
                  👻 Monte, aprenda e decore com o <span className="text-purple-700 font-extrabold">EdukaBoo!</span>
                </span>
              </div>
            </div>
            ...
            <p className="text-lg md:text-xl text-gray-700 leading-relaxed max-w-3xl">
              Um combo completo de <span className="font-semibold text-purple-600">Papercrafts temáticos e atividades recreativas</span>, com personagens icônicos do Halloween e curiosidades divertidas sobre cada um. Perfeito para ensinar, <span className="font-semibold text-purple-600">estimular a paciência e a confiança</span> das crianças ao criarem algo com as próprias mãos!
            </p>
          </div>
