  ...
  return (
    ...
    >
      ...
      <div className="relative w-full h-full neon-checkbox__frame">
        <div className={cn(
          "absolute inset-0 bg-white/20 backdrop-blur-sm rounded border-2 transition-all duration-400 neon-checkbox__box",
          isChecked
          ...
          <div className="absolute inset-[2px] flex items-center justify-center neon-checkbox__check-container">
            <svg
              viewBox="0 0 24 24"
              className={cn(
                "w-4/5 h-4/5 fill-none stroke-green-500 stroke-[3] stroke-linecap-round stroke-linejoin-round [stroke-dasharray:40] origin-center transition-all duration-400 ease-[cubic-bezier(0.16,1,0.3,1)] neon-checkbox__check",
                isChecked
