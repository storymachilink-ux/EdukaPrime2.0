...
-- ============================================
-- Este script APENAS insere as 12 badges
-- Sem deletar nada do sistema novo
-- ============================================

-- INSERIR AS 12 BADGES
-- ============================================
...
SELECT
  ...
  (SELECT COUNT(*) FROM badges) as total_badges_no_banco,
  '12 badges = Sistema original ativado' as info;